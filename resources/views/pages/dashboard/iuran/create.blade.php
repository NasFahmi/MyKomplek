...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow p-7">
        <div class="flex flex-col items-start justify-between gap-4 mb-6 sm:flex-row sm:items-center">
            <h1 class="text-xl font-semibold">Tambah Iuran</h1>
        ...
        {{-- MAIN CONTENT --}}
        {{-- ====================================================== --}}
        <form action="{{ route('pembayaran.fee-type.store') }}" method="post">
            @csrf
            {{-- Nama Lengkap --}}
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="feeType_name" name="name" value="{{ old('name') }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="number" id="amound" name="amount" value="{{ old('amount') }}"
